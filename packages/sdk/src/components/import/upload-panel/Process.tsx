...
import { getFieldIconString, AttachmentManager } from '../../../components/editor/attachment';
  ...
  return (
    <>
      <div className="group relative rounded-sm text-sm">
        ...
        <X
          className="absolute -right-2 -top-2 hidden size-4 cursor-pointer rounded-full bg-secondary p-0.5 hover:opacity-70 group-hover:block"
          onClick={() => onClose()}
        />
      </div>
