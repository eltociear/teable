    ...
    >
      ...
      <CollapsibleContent className="flex flex-col items-start">
        ...
        >
          ...
          />
          <span className="pl-2">{t('import.options.autoSelectFieldOptionName')}</span>
        </label>
        ...
        >
          ...
          />
          <span className="pl-2">{t('import.options.useFirstRowAsHeaderOptionName')}</span>
        </label>
        ...
        >
          ...
          />
          <span className="pl-2">{t('import.options.importDataOptionName')}</span>
        </label>
      </CollapsibleContent>
    </Collapsible>
  );
