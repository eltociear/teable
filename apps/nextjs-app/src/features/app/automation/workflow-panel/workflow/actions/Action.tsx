...
const Action = forwardRef<HTMLDivElement, IActionProps>((props, ref) => {
  ...
  return (
    <div className="group w-96 relative my-4">
      <div
        ref={ref}
        tabIndex={0}
        role="button"
      ...
      >
        ...
        >
          <div className="px-2">
            <AlertTriangle className="w-12 h-12 px-2"></AlertTriangle>
          </div>
          ...
          >
            ...
            <div {...handleProps}>
              <DraggableHandle>VVV</DraggableHandle>
            </div>
          </div>
        </div>
      </div>

      <div className="absolute -top-5 w-full z-50 cursor-pointer">
        <AddActionDropMenu>
          <div
            className={classNames(
