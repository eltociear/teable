    ...
    >
      ...
      <div className="flex items-center justify-between px-2">
        ...
        >
          ...
          <div className="right-[-18px] absolute h-0.5 w-[18px] bg-slate-300 top-[50%]"></div>
        </div>
      ...
      {/* description */}
      <div className="pb-2 px-2 truncate">Send an email Send an email</div>

      {/* actions */}
      <div className="flex">
        <div className="w-1 bg-secondary h-auto"></div>
